...
import type { WorkspaceCreateData, TokenCreateData, TokenUpdateData, SandboxListData, SandboxCreateData, SandboxGetData, SandboxForkData, VmHibernateData, VmUpdateHibernationTimeoutData, VmShutdownData, VmUpdateSpecsData, VmStartData, VmUpdateSpecs2Data } from './types.gen';
 ...
 *
 */
export declare const vmUpdateHibernationTimeout: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<VmUpdateHibernationTimeoutData, ThrowOnError>) => import("@hey-api/client-fetch").RequestResult<import("./types.gen").VMUpdateHibernationTimeoutResponse, unknown, ThrowOnError>;
/**
 * Shutdown a VM
 ...
 *
 */
export declare const vmUpdateSpecs2: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<VmUpdateSpecs2Data, ThrowOnError>) => import("@hey-api/client-fetch").RequestResult<import("./types.gen").VMUpdateSpecsResponse, unknown, ThrowOnError>;
